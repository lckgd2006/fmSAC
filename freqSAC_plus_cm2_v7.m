...
% 调制对比度参数
params.m_s = 0.1;            % 激发调制对比度
params.m_d_1 = 0.3;          % 竞争光1调制对比度
params.m_d_2 = 0.6;          % 竞争光2调制对比度
params.m_d_3 = 0.9;          % 竞争光3调制对比度
params.m_d_4 = 1.0;          % 竞争光4调制对比度
...
fprintf('调制参数:\n');
fprintf('  激发调制对比度 m_s: %.1f\n', params.m_s);
fprintf('  竞争1调制对比度 m_d: %.1f (fmSAC_1)\n', params.m_d_1);
fprintf('  竞争2调制对比度 m_d: %.1f (fmSAC_2)\n', params.m_d_2);
fprintf('  竞争3调制对比度 m_d: %.1f (fmSAC_3)\n', params.m_d_3);
